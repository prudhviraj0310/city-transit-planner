...
export const LOCATIONS: CityLocation[] = [
  { id: 'central_station', name: 'Hyderabad', zone: 1, x: 50, y: 50, type: 'transit_hub', accessible: true },
  { id: 'tech_park', name: 'Bengaluru', zone: 2, x: 75, y: 30, type: 'commercial', accessible: true },
  { id: 'green_valley', name: 'Jaipur', zone: 3, x: 20, y: 25, type: 'residential', accessible: true },
  { id: 'city_mall', name: 'Mumbai', zone: 1, x: 55, y: 60, type: 'commercial', accessible: true },
  { id: 'university', name: 'Pune', zone: 2, x: 35, y: 35, type: 'landmark', accessible: true },
  { id: 'airport', name: 'Delhi', zone: 4, x: 90, y: 15, type: 'transit_hub', accessible: true },
  { id: 'harbor', name: 'Kochi', zone: 3, x: 10, y: 70, type: 'landmark', accessible: false },
  { id: 'old_town', name: 'Lucknow', zone: 1, x: 45, y: 55, type: 'landmark', accessible: false },
  { id: 'sports_arena', name: 'Kolkata', zone: 2, x: 65, y: 45, type: 'landmark', accessible: true },
  { id: 'hospital', name: 'Chennai', zone: 1, x: 40, y: 48, type: 'commercial', accessible: true },
  { id: 'riverside', name: 'Varanasi', zone: 2, x: 30, y: 65, type: 'park', accessible: true },
  { id: 'hilltop', name: 'Shimla', zone: 3, x: 80, y: 70, type: 'park', accessible: false },
  { id: 'downtown', name: 'Ahmedabad', zone: 1, x: 48, y: 42, type: 'commercial', accessible: true },
  { id: 'suburb_north', name: 'Chandigarh', zone: 4, x: 50, y: 10, type: 'residential', accessible: true },
  { id: 'suburb_east', name: 'Bhubaneswar', zone: 4, x: 85, y: 55, type: 'residential', accessible: true },
  { id: 'industrial', name: 'Surat', zone: 3, x: 15, y: 45, type: 'commercial', accessible: true },
  { id: 'museum', name: 'Mysuru', zone: 1, x: 52, y: 38, type: 'landmark', accessible: true },
  { id: 'beach', name: 'Goa', zone: 4, x: 5, y: 85, type: 'park', accessible: false },
];
